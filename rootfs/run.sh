...
function launchmaster() {
  ...
  redis-server /redis-master/redis.conf --port ${MASTER_PORT}
}
...
function launchsentinel() {
  ...
  redis-sentinel ${sentinel_conf} --port ${SENTINEL_PORT}
}
...
function launchslave() {
  ...
  perl -pi -e "s/%master-port%/${MASTER_PORT}/" /redis-slave/redis.conf
